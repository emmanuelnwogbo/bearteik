    ...
    return (
      <>
        <div className="header">
          <div className="header__teiko">
            <p className="">Teiko</p>
          </div>
          <div className="header__social">
            <span className="etherscan" onClick={() => this.openlink('https://etherscan.io/address/0x309A87034A81E555585Fa0a3F541205992Ad7ec2#code')}>
              Etherscan
            </span>
            <span onClick={() => this.openlink('https://opensea.io/collection/teiko-nft')}>
